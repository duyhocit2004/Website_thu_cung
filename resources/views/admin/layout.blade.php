  ...
  <body>
    ...
    <main class="page-wrapper compact-wrapper" id="pageWrapper">
      ...
      <header class="page-header row">
        <div class="logo-wrapper d-flex align-items-center col-auto"><a href="index.html"><img class="for-light" src="{{asset('asset/images/pawly_logo.png')}}" alt="logo"><img class="for-dark" src="../assets/images/logo/dark-logo.png" alt="logo"></a><a class="close-btn" href="javascript:void(0)">
                      ...
                      <table class="table" id="all-invoice">
                        ...
                        <tbody>
                                          <tr>
                                            ...
                                            <td>
                                              <div class="d-flex align-items-center gap-2">
                                                <div class="flex-shrink-0"><img class="b-r-10" src="../assets/images/avatar/10.jpg" alt=""></div>
                                          ...
                                          <tr>
                                            ...
                                            <td>
                                              <div class="d-flex align-items-center gap-2">
                                                <div class="flex-shrink-0"><img class="b-r-10" src="../assets/images/avatar/11.jpg" alt=""></div>
                                                <div class="flex-grow-1"><a href="user-profile.html">
                                          ...
                                          <tr>
                                            ...
                                            <td>
                                              <div class="d-flex align-items-center gap-2">
                                                <div class="flex-shrink-0"><img class="b-r-10" src="../assets/images/avatar/1.jpg" alt=""></div>
                                                <div class="flex-grow-1"><a href="user-profile.html">
                                          ...
                                          <tr>
                                            ...
                                            <td>
                                              <div class="d-flex align-items-center gap-2">
                                                <div class="flex-shrink-0"><img class="b-r-10" src="../assets/images/avatar/3.jpg" alt=""></div>
                                                <div class="flex-grow-1"><a href="user-profile.html">
                      ...
                      <div class="col-sm-4 custom-width-2">
                        ...
                        <div class="team-member">
                          ...
                          <div class="customers d-inline-block avatar-group">
                            <ul>
                                              <li class="d-inline-block"><img class="img-40 b-r-8" src="../assets/images/user/13.jpg" alt="#"></li>
                                              <li class="d-inline-block"><img class="img-40 b-r-8" src="../assets/images/user/6.jpg" alt="#"></li>
                                              <li class="d-inline-block"><img class="img-40 b-r-8" src="../assets/images/user/3.jpg" alt="#"></li>
                      ...
                      <table class="table">
                        ...
                        <tbody>
                                          <tr>
                                            <td>
                                              <div class="d-flex align-items-center gap-2">
                                                <div class="flex-shrink-0"><img src="../assets/images/dashboard1/invest/01.jpg" alt=""></div>
                                                <div class="flex-grow-1"> <a href="user-profile.html">
                                          ...
                                          <tr>
                                            <td>
                                              <div class="d-flex align-items-center gap-2">
                                                <div class="flex-shrink-0"><img src="../assets/images/dashboard1/invest/02.jpg" alt=""></div>
                                                <div class="flex-grow-1"> <a href="user-profile.html">
                                          ...
                                          <tr>
                                            <td>
                                              <div class="d-flex align-items-center gap-2">
                                                <div class="flex-shrink-0"><img src="../assets/images/dashboard1/invest/03.jpg" alt=""></div>
                                                <div class="flex-grow-1"> <a href="user-profile.html">
                                          ...
                                          <tr>
                                            <td>
                                              <div class="d-flex align-items-center gap-2">
                                                <div class="flex-shrink-0"><img src="../assets/images/dashboard1/invest/04.jpg" alt=""></div>
                                                <div class="flex-grow-1"> <a href="user-profile.html">
                      ...
                      <div class="tab-pane fade active show" id="mon" role="tabpanel" aria-labelledby="mon-tab">
                        <ul class="activity-update">
                                          <li class="d-flex align-items-center b-l-primary">
                                            ...
                                            <div class="flex-shrink-0"> <img class="img-40 b-r-10" src="../assets/images/avatar/11.jpg" alt=""></div>
                                          </li>
                                          <li class="d-flex align-items-center b-l-secondary">
                                            ...
                                            <div class="flex-shrink-0"> <img class="img-40 b-r-10" src="../assets/images/avatar/1.jpg" alt=""></div>
                                          </li>
                                          <li class="d-flex align-items-center b-l-tertiary">
                                            ...
                                            <div class="flex-shrink-0"> <img class="img-40 b-r-10" src="../assets/images/avatar/3.jpg" alt=""></div>
                                          </li>
                        </ul>
                      </div>
                      <div class="tab-pane fade" id="tue" role="tabpanel" aria-labelledby="tue-tab">
                        <ul class="activity-update">
                                          <li class="d-flex align-items-center b-l-info">
                                            ...
                                            <div class="flex-shrink-0"> <img class="img-40 b-r-10" src="../assets/images/avatar/2.jpg" alt=""></div>
                                          </li>
                                          <li class="d-flex align-items-center b-l-success">
                                            ...
                                            <div class="flex-shrink-0"> <img class="img-40 b-r-10" src="../assets/images/avatar/4.jpg" alt=""></div>
                                          </li>
                        </ul>
                      </div>
                      <div class="tab-pane fade" id="wed" role="tabpanel" aria-labelledby="wed-tab">
                        <ul class="activity-update">
                                          <li class="d-flex align-items-center b-l-danger">
                                            ...
                                            <div class="flex-shrink-0"> <img class="img-40 b-r-10" src="../assets/images/avatar/5.jpg" alt=""></div>
                                          </li>
                                          <li class="d-flex align-items-center b-l-dark">
                                            ...
                                            <div class="flex-shrink-0"> <img class="img-40 b-r-10" src="../assets/images/avatar/6.jpg" alt=""></div>
                                          </li>
                                          <li class="d-flex align-items-center b-l-warning">
                                            ...
                                            <div class="flex-shrink-0"> <img class="img-40 b-r-10" src="../assets/images/avatar/9.jpg" alt=""></div>
                                          </li>
                        </ul>
                      </div>
                ...
                <div class="card notification-card">
                  ...
                  <div class="card-body p-0">
                    <div class="d-flex bg-light gap-3">
                      <div class="flex-shrink-0"> <img class="img-40 b-r-15" src="../assets/images/avatar/10.jpg" alt="Use1"></div>
                      <div class="flex-grow-1"><a href="user-profile.html">
                    ...
                    <div class="d-flex gap-3">
                      <div class="flex-shrink-0"> <img class="img-40 b-r-15" src="../assets/images/avatar/4.jpg" alt="Use2"></div>
                      <div class="flex-grow-1"><a href="user-profile.html">
                    ...
                    <div class="d-flex gap-3">
                      <div class="flex-shrink-0"> <img class="img-40 b-r-15" src="../assets/images/avatar/12.jpg" alt="Use3"></div>
                      <div class="flex-grow-1"><a href="user-profile.html">
