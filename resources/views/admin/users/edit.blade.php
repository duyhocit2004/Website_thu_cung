                                ...
                                <div class="card-body custom-input checkbox-checked">
                                    <form class="theme-form" method="POST" action="{{ route('users.update', $user->id) }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" disabled id="first-name" type="text" name="name" value="{{ $user->name }}" placeholder="Tên">
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label" for="exampleFormControlInput1">Email</label>
                                            <input class="form-control" disabled id="exampleFormControlInput1" name="email" value="{{ $user->email }}">
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label" for="exampleFormControlInput1">Số điện
                                                thoại</label>
                                            <input class="form-control" disabled id="exampleFormControlInput1" name="phone_number" value="{{ $user->phone }}" type="tel">
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label" for="exampleFormControlInput1">Địa chỉ</label>
                                            <input disabled class="form-control" id="exampleFormControlInput1" value="{{ $user->address }}" type="address"
                                                placeholder="Địa chỉ">
                                        </div>
